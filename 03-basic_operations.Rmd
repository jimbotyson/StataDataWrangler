...
Both commands can be used in conjunction with `replace` to achieve complex operations of generation and modification of variables, for example we may generate a new value and then conditionally make it missing for some cases (don't run this code!):
...
![A box plot graph of the mpg variable from the auto data set with no options specified.](../Stata Training Material General/graphs/mpgbox1.png "A Simple Box Plot")
...
![A box plot graph of the mpg variable from the auto dataset with title added.](../Stata Training Material General/graphs/mpgbox2.png "A Simple Box Plot with Title")
...
![A Box Plot with Title, Subtitle and Note](../Stata Training Material General/graphs/mpgbox3.png "A Box Plot with Title, Subtitle and Note")
...
![A Box Plot with data grouped based on a nominal variable.](../Stata Training Material General/graphs/mpgbox4.png "A Box Plot with data grouped based on a nominal variable.")
...
![A Box Plot with gridlines supressed.](../Stata Training Material General/graphs/images/mpgbox5-1.png "A Box Plot with gridlines supressed.")
...
![A box plot with factor shown by color of box.](../Stata Training Material General/graphs/images/mpgbox5.png "A box plot with factor shown by color of box.")
...
![A box plot with a number of custom color options.](../Stata Training Material General/graphs/images/mpgbox6.png "A box plot with a number of custom color options.")

Here is the chart with some of the regions labelled with relevant code:

![A box plot with a number of custom color options.](../Stata Training Material General/graphs/images/labelledstatachart.png "A box plot with regions labelled.")
...
![A box plot with a number of custom color options.](
images/mpgbox7.png "A box plot with a number of custom color options.")
...
![A simple scatter plot of two continuous variables.](../Stata Training Material General/graphs/images/mpgweight1.png "A simple scatter plot of two continuous variables.")
...
![A scatter plot of two continuous variables with varying marker shapes and colour use.](../Stata Training Material General/graphs/images/mpgweight1-1.png "A scatter plot of two continuous variables with varying marker shapes and colour use.")
...
![A scatter plot of two continuous variables with varying marker shapes and colour use.](../Stata Training Material General/graphs/images/mpgbox5-2.png "A scatter plot of two continuous variables with varying marker shapes and colour use.")
...
![A box plot with the scheme plottig applied.](../Stata Training Material General/graphs/images/mpgbox8.png "A box plot with the scheme plottig applied.")
...
![A scatter plot with group membership indicated by markerhape and scheme plotplain applied.](../Stata Training Material General/graphs/images/mpgweightscatterplain.png "A scatter plot with group membership indicated by markerhape and scheme plotplain applied.")
