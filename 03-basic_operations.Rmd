...
after you run these lines, use `list` to determine if there are any anomalous cases in your data set. Have you detected any? How many?
...
Use either of `generate` to create a new variable `avxm` that is the mean of the three scores, `maths`, `english`, and `history`. Round the result to show no decimal places.
...
&nbsp;&nbsp;&nbsp;&nbsp;If avxm >= 60, stream = "high",<br>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if avxm < 60 & avxm > 50, stream = "mid",<br>
...
<span style="color: red;">
&nbsp;&nbsp;&nbsp;&nbsp;If avxm >= 60, stream = "high",<br>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if avxm < 50, stream = "low",<br>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else stream = "mid"
</span>

In this version I don't have to spell out the compound condition. Win!

Now, to write this in something approaching Stata, I will move the default 'else' condition to the top and use `gen` and `replace` with `if` to get my new variable:

    gen stream = 2 // the else or default condition
    replace stream = 3 if avxm >= 60
    replace stream = 1 if avxm < 50

So I often prefer a numeric code to a string variable. Notice that I have useds 3 for "high" against my own prejudice that it should be 1. In this way Stata and I will agree about ordering the data. I will explicitly label the data later to make it easier to read.
