...
[^basic_operations-2]: [How do I select a subset of observations using a complicated criterion?](https://www.stata.com/support/faqs/data-management/selecting-subset-of-obs "How do I select a subset of observations using a complicated criterion?")
...
## For one continuous and one categorical variable
...
Run the `robvar` procedure above. What are the three **W** statistics produced? Which of them tests that the variances are equal for a comparison of means? Is there strong enough evidence in this case to reject the null hypothesis?
...
Using this procedure, how do English scores compare to History scorses and how do English scores compare to Mathematics scores?
